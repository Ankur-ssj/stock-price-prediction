...
def msftlstmsavedmodel():
    model = load_model("savedmodels/msftsavedmodel.h5")
    ...
    plt.savefig("FrontEnd/stock-price-prediction/src/static/msftstatic/msftlstmfinalgraph.png")
...
def msftarimamodel():
    ...
    plt.savefig("FrontEnd/stock-price-prediction/src/static/msftstatic/msftoriginal.png")
    ...
    plt.savefig("FrontEnd/stock-price-prediction/src/static/msftstatic/msftacf.png")
    ...
    plt.savefig("FrontEnd/stock-price-prediction/src/static/msftstatic/msftpacf.png")
    ...
    plt.savefig("FrontEnd/stock-price-prediction/src/static/msftstatic/msftresidual.png")
...
def msftlinearregression():
    ...
    plt2.legend(loc=4)
    plt2.savefig("FrontEnd/stock-price-prediction/src/static/msftstatic/msftlr.png")
    plt2.close(fig)
